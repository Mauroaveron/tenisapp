...
import com.mauro.tennis.springtennis.mapper.PartidoMapperImpl;
...
class PartidoServiceTest {
    ...
    Jugador jugador1 = new Jugador(1L, "Federer", SCORE_30, entrenador1);
    Jugador jugador2 = new Jugador(2L, "Nadal", SCORE_30, entrenador2);

    JugadorDTO jugadorDTO1 = new JugadorDTO(1L, "Federer", SCORE_30, entrenadorDTO1);
    JugadorDTO jugadorDTO2 = new JugadorDTO(2L, "Nadal", SCORE_30, entrenadorDTO2);
    ...
    PartidoMapper mapper = new PartidoMapperImpl(new CanchaMapperImpl(), jugadorMapper);
