...
import com.mauro.tennis.springtennis.mapper.PartidoMapper;
...
public class PartidoServiceImpl implements PartidoService {
    ...
    private void validarJugadoresParaTorneo(PartidoDTO partido1, PartidoDTO partido2) {
        JugadorDTO jugadorLocalPrimerPartido = partido1.getJugadorLocal();
        JugadorDTO jugadorVisitantePrimerPartido = partido1.getJugadorVisitante();
        JugadorDTO jugadorLocalSegundoPartido = partido2.getJugadorLocal();
        JugadorDTO jugadorVisitanteSegundoPartido = partido2.getJugadorVisitante();

        validarJugadores(partido1);
        validarJugadores(partido2);

        if (jugadorLocalPrimerPartido.getId().equals(jugadorLocalSegundoPartido) || jugadorLocalPrimerPartido.getId().equals(jugadorVisitanteSegundoPartido)
                || jugadorVisitantePrimerPartido.getId().equals(jugadorLocalSegundoPartido) || jugadorVisitantePrimerPartido.getId().equals(jugadorVisitanteSegundoPartido)) {
            throw new IllegalArgumentException(PLAYER_DUPLICATED);
        }
    }

    private void validarOrdenDeJugadoresPorRankingParaTorneo(PartidoDTO partido1, PartidoDTO partido2, JugadorDTO primerJugador, JugadorDTO segundoJugador, JugadorDTO tercerJugador, JugadorDTO cuartoJugador) {


        if (primerJugador.getPuntos() > segundoJugador.getPuntos() && primerJugador.getPuntos() > tercerJugador.getPuntos() && primerJugador.getPuntos() > cuartoJugador.getPuntos()) {
            partido1.setJugadorLocal(primerJugador);
        } else if (primerJugador.getPuntos() > segundoJugador.getPuntos() && primerJugador.getPuntos() > tercerJugador.getPuntos() && primerJugador.getPuntos() < cuartoJugador.getPuntos()
                || primerJugador.getPuntos() > segundoJugador.getPuntos() && primerJugador.getPuntos() < tercerJugador.getPuntos() && primerJugador.getPuntos() > cuartoJugador.getPuntos()
                || primerJugador.getPuntos() < segundoJugador.getPuntos() && primerJugador.getPuntos() > tercerJugador.getPuntos() && primerJugador.getPuntos() > cuartoJugador.getPuntos()) {
            partido2.setJugadorLocal(primerJugador);
        } else if (primerJugador.getPuntos() > segundoJugador.getPuntos() && primerJugador.getPuntos() < tercerJugador.getPuntos() && primerJugador.getPuntos() < cuartoJugador.getPuntos()
                || primerJugador.getPuntos() < segundoJugador.getPuntos() && primerJugador.getPuntos() > tercerJugador.getPuntos() && primerJugador.getPuntos() < cuartoJugador.getPuntos()
                || primerJugador.getPuntos() < segundoJugador.getPuntos() && primerJugador.getPuntos() < tercerJugador.getPuntos() && primerJugador.getPuntos() > cuartoJugador.getPuntos()) {
            partido2.setJugadorVisitante(primerJugador);
        } else if (primerJugador.getPuntos() < segundoJugador.getPuntos() && primerJugador.getPuntos() < tercerJugador.getPuntos() && primerJugador.getPuntos() < cuartoJugador.getPuntos()) {
            partido1.setJugadorVisitante(primerJugador);
        }
    }
